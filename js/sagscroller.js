...
var sagscroller_constants={
	navpanel: {height:'0px', downarrow:'down.gif', opacity:0.0, title:'Go to Next Content', background:'transparent'},
	loadingimg: {src:'images/ajax-loader.gif', dimensions:[0,0]}
}
