...
class ScreenAdAssignment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('screen_id, ad_id, element_id', 'required'),
			array('screen_id, ad_id, create_user_id, update_user_id', 'numerical', 'integerOnly'=>true),
			array('element_id', 'length', 'max'=>64),
			array('create_time, update_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('screen_id, ad_id, element_id, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
